...
function wtf(){
  ...
  for ($i=0;$i<count($backtrace);$i++) {
     echo $backtrace[$i]['function']."<br>";
     echo $backtrace[$i]['line']."<br>";
     echo $backtrace[$i]['file']."<br>";
     echo $backtrace[$i]['class']."<br>";
     echo $backtrace[$i]['object']."<br>";
     echo $backtrace[$i]['type']."<br>";
     echo $backtrace[$i]['args']."<br>";
